          ...
          <div style={{
            ...
            >
              <div style={{
                ...
                <div style={{ position: "absolute", inset: 14, borderRadius: 10, border: "1px dashed rgba(201,168,76,0.22)", zIndex: 2, pointerEvents: "none" }} />
                <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 14 }}>
                  <div style={{ width: 88, height: 88, borderRadius: "50%", backgroundColor: "rgba(13,27,62,0.1)", border: "1px solid rgba(201,168,76,0.3)" }} />
                  <span style={{ fontFamily: "var(--font-dm)", fontSize: "0.62rem", letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--color-text-muted)" }}>
                    Mridu Bhandari
                  </span>
                </div>
